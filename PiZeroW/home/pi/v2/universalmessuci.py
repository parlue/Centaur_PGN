# Play pure MessEmu without DGT Centaur Adaptive Play
#
import gamemanager
import os
import sys
# sys.path.append('/home/pi/v2/board')
sys.path.append('/home/pi/v2/mess')
...
os.chdir("/home/pi/v2/mess")
newengine = "/home/pi/v2/mess/mame -skip_gameinfo -lightgunprovider none -video none -plugin chessengine amsterd"
...
def eventCallback(event):
	...
	if event == gamemanager.EVENT_BLACK_TURN:
		...
		if curturn == computeronturn:
			...
			print(newengine)
			engine = chess.engine.SimpleEngine.popen_uci("/home/pi/v2/mess/mess_amsterd.sh")    #newengine)
			print(engine)
			options = ({"UCI_LimitStrength": True, "UCI_Elo": eloarg})
			print("tag")
			engine.configure(options)
